@echo off
powershell -Command "Add-Type -AssemblyName PresentationFramework; "[System.Windows.MessageBox]::Show('YOU ARE AN IDIOT ', 'Error', 4, 16)"
start msedge.exe
https://www.youtube.com/watch?v=dPtXaAZHuho&t=2s
@echo off
